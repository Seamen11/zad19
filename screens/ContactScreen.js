  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.appContainer}>
        <Button
          title="WhatsApp"
          buttonStyle={styles.buttonWhatsApp}
          icon={<Icon name="logo-whatsapp" type="ionicon" size={20} color="white" />}
        />
        <Button
          title="Telegram"
          buttonStyle={styles.buttonTelegram}
          icon={<Icon name="paper-plane" type="ionicon" size={20} color="white" />}
        />
      </View>
